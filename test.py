...
for i in range(0,len(list_time)-1):
    df_temp = df_schedule[df_schedule['time stamp'].between(list_time[i],list_time[i+1])]
...
#         self.min_value = 10
#         self.max_value = 100
#         self.time_series = self.defining_time_series()

#     def defining_time_series(self):
#         return [random.randint(self.min_value, self.max_value) for _ in range(10)]

# # Create an instance of the MyClass
# myclass = MyClass()

# # Now you can access the time_series attribute of the instance, which is already created during initialization
# print(myclass.time_series)