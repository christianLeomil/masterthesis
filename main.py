...
for k,df in enumerate(list_split):
    ...
    optimizer.options['mipgap'] = control.optimality_gap
    optimizer.options['timelimit'] = control.time_limit
    results = optimizer.solve(instance, tee = control.print_optimality_gap)
